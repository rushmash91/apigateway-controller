...
const (
	FinalizerString = "finalizers.apigateway.services.k8s.aws/APIKey"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("apikeys")
