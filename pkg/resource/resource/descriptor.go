...
const (
	FinalizerString = "finalizers.apigateway.services.k8s.aws/Resource"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("resources")
