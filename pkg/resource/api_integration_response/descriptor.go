...
const (
	FinalizerString = "finalizers.apigateway.services.k8s.aws/APIIntegrationResponse"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("apiintegrationresponses")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.APIIntegrationResponse{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.APIIntegrationResponse),
	}
}
