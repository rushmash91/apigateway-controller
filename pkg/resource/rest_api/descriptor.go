...
const (
	FinalizerString = "finalizers.apigateway.services.k8s.aws/RestAPI"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("restapis")
