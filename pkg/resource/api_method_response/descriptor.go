...
const (
	FinalizerString = "finalizers.apigateway.services.k8s.aws/APIMethodResponse"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("apimethodresponses")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.APIMethodResponse{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.APIMethodResponse),
	}
}
