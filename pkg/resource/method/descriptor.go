...
const (
	FinalizerString = "finalizers.apigateway.services.k8s.aws/Method"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("methods")
